...
export async function menuPrincipal() {
    console.clear();
    console.log("=== GESTIÓN DE INCIDENTES ===");
    console.log("1. Ver tickets activos / Cambiar estado");
...
async function gestionarEstadoTicket(ticket) {
    console.clear();
...
//# sourceMappingURL=CliInterfaces.js.map